...
Current release: **3.7.7 — Legacy Windows forensic evidence adapter**.
...
| [docs/legacy-orphan-recovery.md](docs/legacy-orphan-recovery.md) | Evidence-bound legacy orphan recovery + V1 forensic adapter (3.7.7) |
