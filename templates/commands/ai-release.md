...
6. verify migration/upgrade safety for existing installations where applicable;
...
Any unresolved security finding, plaintext/tracked secret, failed clean install, unsafe migration, invalid production package, failed required test, or mandatory external validation not executed requires `NOT_READY_FOR_PRODUCTION`.
