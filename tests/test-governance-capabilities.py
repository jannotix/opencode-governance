...
class GovernanceCapabilitiesTests(unittest.TestCase):
    ...
    def test_install_uses_one_canonical_manifest_and_preserves_routing(self) -> None:
        ...
        self.assertEqual("4.0.1", manifest["governance_version"])
        self.assertEqual("4.0.1", manifest["architect_runner_version"])
        self.assertEqual("4.0.1", manifest["context_intelligence_version"])
        self.assertEqual("4.0.1", manifest["workflow_continuation_version"])
        ...
        self.assertEqual(22, len(manifest["managed_tools"]))
