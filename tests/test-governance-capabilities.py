...
class GovernanceCapabilitiesTests(unittest.TestCase):
    ...
    def test_install_uses_one_canonical_manifest_and_preserves_routing(self) -> None:
        ...
        self.assertEqual("4.1.0", manifest["governance_version"])
        self.assertEqual("4.1.0", manifest["architect_runner_version"])
        self.assertEqual("4.1.0", manifest["context_intelligence_version"])
        self.assertEqual("4.1.0", manifest["workflow_continuation_version"])
