...
OpenCode Governance 3.7.2 includes deterministic candidate authority, content-bound approval receipts, actionable continuation, focused review lenses, governed engineering memory, exact evidence reuse, a staged pre-commit gate and deterministic OpenCode simulation.
