...
if(Test-Path -LiteralPath $ManifestPath -PathType Leaf){
    ...
    if($Version-in@('3.3.2','3.3.3','3.3.4','3.4.0','3.4.1')){
        ...
        if($Version-in@('3.4.0','3.4.1')){$Expected+=@((Join-Path $ToolsDir 'context-intelligence.ps1'),(Join-Path $ToolsDir 'context-intelligence.sh'),(Join-Path $ToolsDir 'context-intelligence.py'))}
        ...
        $Remove=@($Expected[0],$Expected[1]);if($Version-in@('3.4.0','3.4.1')){$Remove+=$Expected[4..6]}
