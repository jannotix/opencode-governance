...
@(
  ...
  'commands\ai-init.md','commands\ai-audit.md','commands\ai-docs.md','commands\ai-plan.md','commands\ai-execute.md','commands\ai-review.md','commands\ai-workflow.md','commands\ai-status.md','commands\ai-resume.md','commands\ai-release.md'
) | ForEach-Object {
