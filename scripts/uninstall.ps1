...
@(
  ...
  'commands\ai-init.md','commands\ai-audit.md','commands\ai-plan.md','commands\ai-execute.md','commands\ai-review.md','commands\ai-workflow.md','commands\ai-status.md','commands\ai-release.md'
) | ForEach-Object {
    $Path = Join-Path $ConfigDir $_
    if (Test-Path $Path) { Remove-Item $Path -Force }
}
Write-Host 'Governance agents, governed Build/Plan overrides and commands removed. Existing provider authentication, project .ai state and backups were left untouched.'
