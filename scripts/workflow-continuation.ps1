...
$NonTerminal=@(
    ...
    'DISCOVERY_DUAL_REVIEW','DISCOVERY_ADJUDICATION','DISCOVERY_PASS','PRODUCT_SCOPE_APPROVAL',
    'PRODUCT_SCOPE_APPROVED','CONTEXT_ROUTING','CONTEXT_SUFFICIENT','DELIVERY_ARCHITECTURE',
    'VERTICAL_MILESTONE_PLANNING','EVIDENCE_PLANNING','OPERATIONAL_PLANNING','READY_FOR_EXECUTION',
    'PRE_CHANGE_SAFEPOINT_WHEN_REQUIRED','IMPLEMENTING','IMPLEMENTATION','DOCUMENTATION_SYNC',
    'EVIDENCE_VALIDATION','OPERATIONAL_VALIDATION','EVIDENCE_AND_OPERATIONAL_VALIDATION',
    'TASK_VALIDATED','DUAL_REVIEW','DUAL_REVIEW_COMPLETE','TASK_DUAL_REVIEW','FINAL_ADJUDICATION',
    'FINAL_ADJUDICATION_PASS','TASK_FINAL_ADJUDICATION','PRODUCT_COMPLETENESS_RECONCILIATION',
    'PRODUCT_INCOMPLETE','MILESTONE_VALIDATED','RELEASE_READINESS','RELEASE_READY','VALIDATED_LEARNING',
    'AUDIT_PASS','BASELINE_PASS','BASELINE_VALIDATED'
)
