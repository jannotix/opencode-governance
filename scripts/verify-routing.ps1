...
$Supported=@('3.3.2','3.3.3','3.3.4','3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4')
...
if($Version-in@('3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4')){
...
$ContextVersions=@('3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4')
$HardenedVersions=@('3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4')
$FingerprintVersions=@('3.3.4','3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4')
$PowerShell7Versions=@('3.3.3','3.3.4','3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4')
if($Version-in$ContextVersions){
    ...
    if($Version-in@('3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4')){
        $ExpectedTools+=@(
...
if($Version-in@('3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4')){$GateMarkers+=@('WINDOWS_COMMAND:','UNIX_COMMAND:','-ProjectDir','--project-dir','<ORIGINAL_ARGUMENTS>')}
...
if($Version-in@('3.7.2','3.7.3','3.7.4')){
...
if($Version-in$FingerprintVersions){
    ...
    if($Version-in@('3.7.2','3.7.3','3.7.4')){foreach($Value in @('ai-resume','TOOL_EXECUTION_ABORTED','ARCHITECT_ORPHAN_RECOVERED','RESUME_POST_SIDE_EFFECT','ARCHITECT_TRANSACTION_V1','PRE_SIDE_EFFECT','POST_SIDE_EFFECT')){if($PowerShellRunner-notlike"*$Value*"-or$UnixRunner-notlike"*$Value*"){throw "Architect runner missing 3.7.2 reliability marker: $Value"}}}
    if($Version-in@('3.7.3','3.7.4')){
