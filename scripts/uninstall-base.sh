...
if version in {'3.3.2','3.3.3','3.3.4','3.4.0','3.4.1','3.4.2','3.4.3','3.4.4'}:
    ...
    names=['architect-attempt.ps1','architect-attempt.sh']
    if version=='3.4.4': names += ['architect-headless-contract.py']
    names += ['executor-attempt.ps1','executor-attempt.sh']
    ...
    if version=='3.4.4': remove += ['architect-headless-contract.py']
