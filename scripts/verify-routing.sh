...
case "$version" in 3.3.2|3.3.3|3.3.4|3.4.0|3.4.1|3.4.2|3.4.3|3.4.4|3.6.0|3.7.0|3.7.1|3.7.2|3.7.3|3.7.4|3.7.5|3.7.6|3.7.7|3.8.0|4.0.0|4.0.1);;*) echo "Unsupported routing manifest governance_version: $version" >&2; exit 1;; esac
...
context_versions={'3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1'}
hardened_versions={'3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1'}
fingerprint_versions={'3.3.4','3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1'}
powershell7_versions={'3.3.3','3.3.4','3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1'}
workflow_versions={'3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1'}
capability_versions={'3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1'}
...
if version in fingerprint_versions:
    ...
    if version in {'3.7.6','3.7.7','3.8.0','4.0.0','4.0.1'}:
        ...
        if version == '4.0.1':
            ...
            for value in ['EFFECT_PLUGIN_INSTALLATION_CONTRACT_V1','EFFECT_PLUGIN_RUNTIME_SELF_TEST_V1','ROLE_EFFECT_ENFORCEMENT_V1_1']:
                if value not in effect_raw:
                    raise SystemExit(f'effect plugin installer missing 4.0.1 marker: {value}')
            for value in ['OPENCODE_GOVERNANCE_EFFECT_ENFORCEMENT_ACTIVE','OPENCODE_GOVERNANCE_ROLE','GOVERNED_ROLE_LAUNCH_CONTRACT_V1']:
                if value not in ps_runner:
                    raise SystemExit(f'Architect runner missing 4.0.1 role-launch marker: {value}')
            if 'OPENCODE_GOVERNANCE_EFFECT_ENFORCEMENT_ACTIVE' not in sh_runner or 'OPENCODE_GOVERNANCE_ROLE' not in sh_runner:
                raise SystemExit('Unix Architect runner missing 4.0.1 role-launch markers')
