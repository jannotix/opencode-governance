...
expected=list(base)
if version in {'3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}:
    ...
    if version in {'3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}:
...
context_versions={'3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}
hardened_versions={'3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}
fingerprint_versions={'3.3.4','3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}
powershell7_versions={'3.3.3','3.3.4','3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}
workflow_versions={'3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}
capability_versions={'3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}
...
if version in context_versions:
    ...
    if version in {'3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}:
...
if version in {'3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}:
...
if version in fingerprint_versions:
    ...
    if version in {'3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}:
    ...
    if version in {'3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}:
    ...
    if version in {'3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}:
    ...
    if version in {'3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}:
        ...
        if version in {'3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3','4.0.3'}:
            ...
            if version == '4.0.2','4.0.3':
                for value in ['DETERMINISTIC_ROLE_REPORT_INGESTION_V3','REVIEW_CHAIN_ATTESTATION_V3']:
                    if value not in ingest_raw:
                        raise SystemExit(f'role-report-ingest missing 4.0.2 marker: {value}')
                for name in ['governed-role-attempt.py','governance-read-git.py']:
                    if not (tools/name).is_file():
                        raise SystemExit(f'Managed 4.0.2 tool missing: {name}')
            else:
