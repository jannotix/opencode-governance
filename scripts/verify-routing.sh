...
case "$version" in 3.3.2|3.3.3|3.3.4|3.4.0|3.4.1|3.4.2|3.4.3|3.4.4|3.6.0|3.7.0|3.7.1|3.7.2|3.7.3|3.7.4|3.7.5|3.7.6|3.7.7|3.8.0|4.0.0|4.0.1|4.0.2|4.0.3);;*) echo "Unsupported routing manifest governance_version: $version" >&2; exit 1;; esac
...
expected=list(base)
if version in {'3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}:
    ...
    if version in {'3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}:
...
context_versions={'3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}
hardened_versions={'3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}
fingerprint_versions={'3.3.4','3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}
powershell7_versions={'3.3.3','3.3.4','3.4.0','3.4.1','3.4.2','3.4.3','3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}
workflow_versions={'3.4.4','3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}
capability_versions={'3.6.0','3.7.0','3.7.1','3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}
...
if version in context_versions:
    ...
    if version in {'3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}:
        ...
        if version in {'4.0.1', '4.0.2','4.0.3'}:
            expected += [tools/'install-effect-plugin.py', tools/'governed-role-launch.py']
            if version in {'4.0.2','4.0.3'}:
                expected += [tools/'governed-role-attempt.py', tools/'governance-read-git.py']
            if version == '4.0.3':
                expected += [tools/name for name in ['route-receipt.py','review-orchestration.py','tool-capability-manifest.py']]
...
if version in {'3.7.2','3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}:
...
if version in fingerprint_versions:
    ...
    if version in {'3.7.3','3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}:
    ...
    if version in {'3.7.4','3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}:
    ...
    if version in {'3.7.5','3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}:
    ...
    if version in {'3.7.6','3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}:
        ...
        if version in {'3.7.7','3.8.0','4.0.0','4.0.1','4.0.2','4.0.3'}:
        ...
        if version in {'4.0.1', '4.0.2','4.0.3'}:
            effect_installer = tools/'install-effect-plugin.py'
            if not effect_installer.is_file():
                raise SystemExit('Managed effect plugin installer missing')
            effect_raw = effect_installer.read_text(encoding='utf-8')
            for value in ['EFFECT_PLUGIN_INSTALLATION_CONTRACT_V1','EFFECT_PLUGIN_RUNTIME_SELF_TEST_V1']:
                if value not in effect_raw:
                    raise SystemExit(f'effect plugin installer missing marker: {value}')
            for value in ['OPENCODE_GOVERNANCE_EFFECT_ENFORCEMENT_ACTIVE','OPENCODE_GOVERNANCE_ROLE']:
                if value not in ps_runner:
                    raise SystemExit(f'Architect runner missing role-launch marker: {value}')
            if 'GOVERNED_ROLE_LAUNCH_CONTRACT_V2' not in ps_runner and 'GOVERNED_ROLE_LAUNCH_CONTRACT_V1' not in ps_runner:
            ...
            if version in {'4.0.2','4.0.3'}:
                # 4.0.2 expects V3 chain markers; 4.0.3 also ships V4 + transactions.
                # Only markers that appear in role-report-ingest.py are checked here.
                expected_markers = ['DETERMINISTIC_ROLE_REPORT_INGESTION_V3']
                if version == '4.0.3':
                    expected_markers += ['REVIEW_CHAIN_ATTESTATION_V4', 'AUTHORITATIVE_ROUTE_RECEIPT_V1',
                                         'DETERMINISTIC_ROLE_REPORT_TRANSACTION_V1']
                else:
                    expected_markers += ['REVIEW_CHAIN_ATTESTATION_V3']
                for value in expected_markers:
                    if value not in ingest_raw:
                        raise SystemExit(f'role-report-ingest missing {version} marker: {value}')
                for name in (['governed-role-attempt.py','governance-read-git.py']
                             + (['route-receipt.py','review-orchestration.py','tool-capability-manifest.py'] if version == '4.0.3' else [])):
                    if not (tools/name).is_file():
                        raise SystemExit(f'Managed {version} tool missing: {name}')
            else:
