...
data['governance_version'] = '3.3.2'
data['architect_runner_version'] = '3.3.2'
data['managed_tools'] = [
...
echo "Installed OpenCode Governance v3.3.2 — Architect Runner Integration Fix."
echo "Direct Architect pre-execution commands now fail closed with the exact installed runner path; routed child attempts are marker-protected."
