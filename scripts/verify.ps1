...
foreach($Marker in @('WORKFLOW_CONTINUATION_GATE_V1','CONTINUE_REQUIRED','TERMINAL_ALLOWED')){Require-Text (Join-Path $ConfigDir 'commands\ai-workflow.md') $Marker;Require-Text (Join-Path $ConfigDir 'commands\ai-resume.md') $Marker}
