...
rm -f "$CONFIG_DIR/commands/ai-init.md" "$CONFIG_DIR/commands/ai-audit.md" "$CONFIG_DIR/commands/ai-docs.md" "$CONFIG_DIR/commands/ai-plan.md" "$CONFIG_DIR/commands/ai-execute.md" "$CONFIG_DIR/commands/ai-review.md" "$CONFIG_DIR/commands/ai-workflow.md" "$CONFIG_DIR/commands/ai-status.md" "$CONFIG_DIR/commands/ai-release.md"
