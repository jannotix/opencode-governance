...
if version in {'3.3.2','3.3.3','3.3.4','3.4.0','3.4.1','3.4.2','3.4.3'}:
    ...
    if version in {'3.4.0','3.4.1','3.4.2','3.4.3'}: names += ['context-intelligence.ps1','context-intelligence.sh','context-intelligence.py']
    ...
    if version in {'3.4.0','3.4.1','3.4.2','3.4.3'}: remove += ['context-intelligence.ps1','context-intelligence.sh','context-intelligence.py']
