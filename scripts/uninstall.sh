...
rm -f "$CONFIG_DIR/agents/architect.md" "$CONFIG_DIR/agents/executor.md" "$CONFIG_DIR/agents/reviewer.md" "$CONFIG_DIR/agents/reviewer-architecture.md" "$CONFIG_DIR/agents/final-reviewer.md"
